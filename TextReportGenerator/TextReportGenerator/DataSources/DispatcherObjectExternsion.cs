...
namespace TextReportGenerator
{
  public static class DispatcherObjectExternsion
  {
    ...
    public static object SafeConvertInvariantStringTo(this string text, Type type)
    {
      ...
      object ret = null;
      Application.Current.Dispatcher.Invoke(new Action(() => ret = System.ComponentModel.TypeDescriptor.GetConverter(type).ConvertFromInvariantString(text)));
      return ret;
    }
    public static T SafeConvertInvariantStringTo<T>(this string text)
    {
      if (Application.Current == null || Application.Current.CheckAccess())
        return (T)System.ComponentModel.TypeDescriptor.GetConverter(typeof(T)).ConvertFromInvariantString(text);

      T ret = default(T);
      Application.Current.Dispatcher.Invoke(new Action(() => ret = (T)System.ComponentModel.TypeDescriptor.GetConverter(typeof(T)).ConvertFromInvariantString(text)));
      return ret;
    }
    ...
    public static T SafeCreateInstance<T>(this object refObject, params object[] args)
    {
      try
      {
        Type type = typeof(T);

        var dispatcherObject = refObject as DispatcherObject ?? Application.Current;
    ...
    public static object SafeGetValue(this DependencyObject dependencyObject, string propertyName)
    {
      ...
      object ret = null;
      dependencyObject.Dispatcher.Invoke(new Action(delegate { ret = ppInfo.GetValue(dependencyObject, new object[] { }); }));
      return ret;
    }
    ...
    public static int SafeGetCount(this Point3DCollection reference)
    {
      if (reference.CheckAccess())
        return reference.Count;

      int ret = 0;
      reference.Dispatcher.Invoke(new Action(delegate { ret = reference.Count; }));
      return ret;
    }
    public static Point3D SafeGetIndex(this Point3DCollection reference, int index)
    {
      if (reference.CheckAccess())
        return reference[index];

      Point3D ret = default(Point3D);
      reference.Dispatcher.Invoke(new Action(delegate { ret = reference[index]; }));
      return ret;
    }
    public static void SafeSetAt(this Point3DCollection reference, int index, Point3D value)
    {
      if (reference.CheckAccess())
      {
      ...
      reference.Dispatcher.Invoke(new Action(delegate { reference[index] = value; }));
    }
    public static void SafeClear(this Point3DCollection reference)
    {
      if (reference.CheckAccess())
      {
        reference.Clear();
      ...
      reference.Dispatcher.Invoke(new Action(delegate { reference.Clear(); }));
    }
    public static void SafeAdd(this Point3DCollection reference, Point3D value)
    {
      if (reference.CheckAccess())
      {
        reference.Add(value);
      ...
      reference.Dispatcher.Invoke(new Action(delegate { reference.Add(value); }));
    }
    public static void SafeRemove(this Point3DCollection reference, Point3D value)
    {
      if (reference.CheckAccess())
      {
      ...
      reference.Dispatcher.Invoke(new Action(delegate { reference.Remove(value); }));
    }
    public static void SafeRemoveAt(this Point3DCollection reference, int index)
    {
      if (reference.CheckAccess())
      {
      ...
      reference.Dispatcher.Invoke(new Action(delegate { reference.RemoveAt(index); }));
    }

    public static int SafeGetCount(this PointCollection reference)
    {
      if (reference.CheckAccess())
        return reference.Count;
    ...
    public static System.Windows.Point SafeGetAt(this PointCollection reference, int index)
    {
      if (reference.CheckAccess())
        return reference[index];
    ...
    public static void SafeSetAt(this PointCollection reference, int index, System.Windows.Point value)
    {
      if (reference.CheckAccess())
      {
        reference[index] = value;
    ...
    public static void SafeClear(this PointCollection reference)
    {
      if (reference.CheckAccess())
      {
        reference.Clear();
    ...
    public static void SafeAdd(this PointCollection reference, System.Windows.Point value)
    {
      if (reference.CheckAccess())
      {
        reference.Add(value);
    ...
    public static void SafeRemove(this PointCollection reference, System.Windows.Point value)
    {
      if (reference.CheckAccess())
      {
        reference.Remove(value);
    ...
    public static void SafeRemoveAt(this PointCollection reference, int index)
    {
      if (reference.CheckAccess())
      {
        reference.RemoveAt(index);
    ...
    public static void SafeSetValue(this DependencyObject dependencyObject, string propertyName, object value)
    {
      ...
      dependencyObject.Dispatcher.Invoke(new Action(delegate { ppInfo.SetValue(dependencyObject, value, new object[] { }); }));
    }
    public static void SafeSetValue(this PropertyInfo ppInfo, object obj, object value)
    {
      ...
      if (dispatcherObject == null || dispatcherObject.CheckAccess())
      {
        if (value != null && value.GetType() != ppInfo.PropertyType)
        {
    ...
    public static List<DependencyProperty> GetDependencyProperties(this Object obj)
    {
      ...
      return (from mp in markupObject.Properties where mp.DependencyProperty != null select mp.DependencyProperty).ToList();
    }
